...
dim_after_conv3 = (dim_after_conv2 + 2*PAD3 - DIL*(KER_SIZE3-1))//POOL_SIZE
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(KER2, KER3, KER_SIZE3, padding=PAD3, dilation=DIL)
    ...
    def forward(self, x):
        ...
        x = self.pool(torch.relu(self.bnc3(self.conv3(x))))
        ...
        x = torch.relu(self.bnf3(self.fc3(x)))
